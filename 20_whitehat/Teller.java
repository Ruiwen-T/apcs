...
QCC
- If the instance variables are private, can toString() still run? (since it calls the vars to print them)
*/
...
public class Teller {
	public static void main(String[] args){
        ...
        System.out.println(leopard.authenticate(123456788, "password")); //expected: false, testing wrong acctNum
        System.out.println(leopard.authenticate(123456789, "passwor")); //expected: false, testing wrong passwd
        System.out.println(leopard.authenticate(12345678, "passwor")); //expected: false, testing wrong acctNum and passwd
