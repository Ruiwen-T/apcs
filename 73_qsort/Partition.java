 ...
 * The Mysterion method ... Picks a pivot number by taking the average of the lower and upper bounds.
     It places the value at the pivot number to its rightful index, and returns that index.
     It ensures that the numbers to the left of the new pivot position are smaller than the corresponding element and the ones to the right are greater than it.
 * <p>
